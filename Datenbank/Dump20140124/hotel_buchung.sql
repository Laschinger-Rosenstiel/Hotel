...
CREATE TABLE `buchung` (
  ...
  PRIMARY KEY (`BID`),
  KEY `Gast_idx` (`GID`),
  CONSTRAINT `Gast` FOREIGN KEY (`GID`) REFERENCES `gast` (`GID`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `buchung` VALUES (1,1,'2014-01-21',500),(2,2,'2014-01-22',580);
...
-- Dump completed on 2014-01-24 16:33:50

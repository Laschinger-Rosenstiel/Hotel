...
CREATE TABLE `zimmer-buchung` (
  ...
  KEY `Buchung_idx` (`BID`),
  KEY `Zimmer_idx` (`ZID`),
  CONSTRAINT `Zimmer` FOREIGN KEY (`ZID`) REFERENCES `zimmer` (`ZID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `zimmer-buchung` VALUES (1,1,'1.001','2014-03-05','2014-03-10'),(2,2,'1.002','2014-03-20','2014-03-25');
